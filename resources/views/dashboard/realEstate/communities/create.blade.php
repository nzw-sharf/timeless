                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select multiple="multiple" data-placeholder="Select Categories" style="width: 100%;" class="select2 form-control @error('categoryIds') is-invalid @enderror" id="categoryIds" name="categoryIds[]">
