                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row float-right">
                                <a href="{{ route('dashboard.projects.stats.statData.create', [$project->id, $stat->id]) }}" class="btn btn-block btn-primary">
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                    New Project Stat Value
                                </a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    @foreach ($stat->values as $key => $data)
                                        <tr>
                                            ...
                                            <td class="project-actions text-right">
                                                <form method="POST"
                                                    action="{{ route('dashboard.projects.stats.statData.destroy', [$project->id,$stat->id, $data->id]) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a class="btn btn-info btn-sm"
                                                        href="{{ route('dashboard.projects.stats.statData.edit', [$project->id,$stat->id,$data->id]) }}">
