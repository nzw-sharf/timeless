            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('dashboard/dynamicPages') }}">Dynamic Pages</a></li>
                        <li class="breadcrumb-item active">New Dynamic Page</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">New Dynamic Page Form</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-boder" method="POST"
                        action="{{ route('dashboard.dynamicPages.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('page_name') }}" class="form-control @error('page_name') is-invalid @enderror" id="page_name" placeholder="Enter Page name" name="page_name" required>
                                            @error('page_name')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('slug') }}" class="form-control @error('slug') is-invalid @enderror" id="slug" placeholder="Enter Page slug" name="slug" required>
                                            @error('slug')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
