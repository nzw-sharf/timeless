                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">New Partner Form</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-boder"id="storeForm"  method="POST"
                        action="{{ route('dashboard.partners.store') }}"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="video_iframe" class=" form-control @error('video_iframe') is-invalid @enderror"
                                                name="video_iframe">{{ old('video_iframe') }}</textarea>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="less_description"
                                                class="summernote form-control @error('less_description') is-invalid @enderror" name="less_description">{{ old('less_description') }}</textarea>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="more_description"
                                                class="summernote form-control @error('more_description') is-invalid @enderror" name="more_description">{{ old('more_description') }}</textarea>
